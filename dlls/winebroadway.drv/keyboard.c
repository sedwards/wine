...
jboolean keyboard_event( JNIEnv *env, jobject obj, jint win, jint action, jint keycode, jint state )
{
    ...
    {
        p__broadway_log_print( BROADWAY_LOG_WARN, "wine",
    ...
    p__broadway_log_print( BROADWAY_LOG_INFO, "wine",
 ...
 */
INT BROADWAY_GetKeyNameText( LONG lparam, LPWSTR buffer, INT size )
{
    int scancode, vkey;
    const char *name;
    char key[2];
...
/***********************************************************************
 *           BROADWAY_MapVirtualKeyEx
 */
UINT BROADWAY_MapVirtualKeyEx( UINT code, UINT maptype, HKL hkl )
{
    UINT ret = 0;
    const char *s;
...
/***********************************************************************
 *           BROADWAY_VkKeyScanEx
 */
SHORT BROADWAY_VkKeyScanEx( WCHAR ch, HKL hkl )
{
    SHORT ret = -1;

 ...
 */
static struct broadway_win_data *get_win_data( HWND hwnd )
{
    struct broadway_win_data *data;
 ...
 */
static void release_win_data( struct broadway_win_data *data )
{
...
void desktop_changed( JNIEnv *env, jobject obj, jint width, jint height )
{
    ...
    p__broadway_log_print( BROADWAY_LOG_INFO, "wine", "desktop_changed: %ux%u", width, height );
    send_event( &data );
}
...
void config_changed( JNIEnv *env, jobject obj, jint dpi )
{
    ...
    data.cfg.dpi = dpi;
    p__broadway_log_print( BROADWAY_LOG_INFO, "wine", "config_changed: %u dpi", dpi );
    send_event( &data );
}
...
void surface_changed( JNIEnv *env, jobject obj, jint win, jobject surface, jboolean client )
{
    ...
    if (surface)
    {
        ...
        p__broadway_log_print( BROADWAY_LOG_INFO, "wine", "surface_changed: %p %s %ux%u",
...
LRESULT BROADWAY_DesktopWindowProc( HWND hwnd, UINT msg, WPARAM wp, LPARAM lp )
{
    switch (msg)
    {
...
/***********************************************************************
 *           BROADWAY_ProcessEvents
 */
BOOL BROADWAY_ProcessEvents( DWORD mask )
{
...
/**********************************************************************
 *           BROADWAY_CreateWindow
 */
BOOL BROADWAY_CreateWindow( HWND hwnd )
{
    TRACE( "%p\n", hwnd );
...
/***********************************************************************
 *           BROADWAY_DestroyWindow
 */
void BROADWAY_DestroyWindow( HWND hwnd )
{
    struct broadway_win_data *data;
...
/***********************************************************************
 *           BROADWAY_WindowPosChanging
 */
BOOL BROADWAY_WindowPosChanging( HWND hwnd, HWND insert_after, UINT swp_flags,
...
/***********************************************************************
 *           BROADWAY_WindowPosChanged
 */
void BROADWAY_WindowPosChanged( HWND hwnd, HWND insert_after, UINT swp_flags,
 ...
 *           BROADWAY_ShowWindow
 */
UINT BROADWAY_ShowWindow( HWND hwnd, INT cmd, RECT *rect, UINT swp )
{
 ...
 *	     BROADWAY_SetParent
 */
void BROADWAY_SetParent( HWND hwnd, HWND parent, HWND old_parent )
{
    struct broadway_win_data *data;
 ...
 *           BROADWAY_SetCapture
 */
void BROADWAY_SetCapture( HWND hwnd, UINT flags )
{
 ...
 *           BROADWAY_SetCursor
 */
void BROADWAY_SetCursor( HWND hwnd, HCURSOR handle )
{
    if (handle)
    {
...
/***********************************************************************
 *           BROADWAY_SetWindowStyle
 */
void BROADWAY_SetWindowStyle( HWND hwnd, INT offset, STYLESTRUCT *style )
{
    struct broadway_win_data *data;
...
/***********************************************************************
 *           BROADWAY_SetWindowRgn
 */
void BROADWAY_SetWindowRgn( HWND hwnd, HRGN hrgn, BOOL redraw )
{
    struct broadway_win_data *data;
...
/***********************************************************************
 *	     BROADWAY_SetLayeredWindowAttributes
 */
void BROADWAY_SetLayeredWindowAttributes( HWND hwnd, COLORREF key, BYTE alpha, DWORD flags )
{
    struct broadway_win_data *data;
...
/*****************************************************************************
 *           BROADWAY_UpdateLayeredWindow
 */
BOOL BROADWAY_UpdateLayeredWindow( HWND hwnd, const UPDATELAYEREDWINDOWINFO *info,
...
/**********************************************************************
 *           BROADWAY_WindowMessage
 */
LRESULT BROADWAY_WindowMessage( HWND hwnd, UINT msg, WPARAM wp, LPARAM lp )
{
    struct broadway_win_data *data;

    switch (msg)
    {
    case WM_BROADWAY_REFRESH:
...
/***********************************************************************
 *           BROADWAY_CreateDesktop
 */
BOOL BROADWAY_CreateDesktop( const WCHAR *name, UINT width, UINT height )
{

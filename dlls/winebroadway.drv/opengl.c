...
/***********************************************************************
 *		broadway_wglGetExtensionsStringARB
 */
static const char *broadway_wglGetExtensionsStringARB( HDC hdc )
{
    TRACE( "() returning \"%s\"\n", wgl_extensions );
...
/***********************************************************************
 *		broadway_wglGetExtensionsStringEXT
 */
static const char *broadway_wglGetExtensionsStringEXT(void)
{
    TRACE( "() returning \"%s\"\n", wgl_extensions );
    return wgl_extensions;
}
...
/***********************************************************************
 *		broadway_wglCreateContextAttribsARB
 */
static struct wgl_context *broadway_wglCreateContextAttribsARB( HDC hdc, struct wgl_context *share,
                                                               const int *attribs )
{
...
/***********************************************************************
 *		broadway_wglMakeContextCurrentARB
 */
static BOOL broadway_wglMakeContextCurrentARB( HDC draw_hdc, HDC read_hdc, struct wgl_context *ctx )
{
    BOOL ret = FALSE;
...
/***********************************************************************
 *		broadway_wglSwapIntervalEXT
 */
static BOOL broadway_wglSwapIntervalEXT( int interval )
{
    BOOL ret = TRUE;
...
/***********************************************************************
 *		broadway_wglGetSwapIntervalEXT
 */
static int broadway_wglGetSwapIntervalEXT(void)
{
    return swap_interval;
}

/***********************************************************************
 *		broadway_wglSetPixelFormatWINE
 */
static BOOL broadway_wglSetPixelFormatWINE( HDC hdc, int format )
{
    return set_pixel_format( hdc, format, TRUE );
}

/***********************************************************************
 *		broadway_wglCopyContext
 */
static BOOL broadway_wglCopyContext( struct wgl_context *src, struct wgl_context *dst, UINT mask )
{
...
/***********************************************************************
 *		broadway_wglCreateContext
 */
static struct wgl_context *broadway_wglCreateContext( HDC hdc )
{
...
/***********************************************************************
 *		broadway_wglDeleteContext
 */
static BOOL broadway_wglDeleteContext( struct wgl_context *ctx )
{
    pthread_mutex_lock( &drawable_mutex );
...
/***********************************************************************
 *		broadway_wglDescribePixelFormat
 */
static int broadway_wglDescribePixelFormat( HDC hdc, int fmt, UINT size, PIXELFORMATDESCRIPTOR *pfd )
{
    EGLint val;
    EGLConfig config;
...
/***********************************************************************
 *		broadway_wglGetPixelFormat
 */
static int broadway_wglGetPixelFormat( HDC hdc )
{
    struct gl_drawable *gl;
    int ret = 0;
    HWND hwnd;
...
/***********************************************************************
 *		broadway_wglGetProcAddress
 */
static PROC broadway_wglGetProcAddress( LPCSTR name )
{
    PROC ret;
...
/***********************************************************************
 *		broadway_wglMakeCurrent
 */
static BOOL broadway_wglMakeCurrent( HDC hdc, struct wgl_context *ctx )
{
    BOOL ret = FALSE;
    struct gl_drawable *gl;
    HWND hwnd;
...
/***********************************************************************
 *		broadway_wglSetPixelFormat
 */
static BOOL broadway_wglSetPixelFormat( HDC hdc, int format, const PIXELFORMATDESCRIPTOR *pfd )
{
    return set_pixel_format( hdc, format, FALSE );
}

/***********************************************************************
 *		broadway_wglShareLists
 */
static BOOL broadway_wglShareLists( struct wgl_context *org, struct wgl_context *dest )
{
    FIXME( "%p %p\n", org, dest );
    return FALSE;
}
...
/***********************************************************************
 *		broadway_wglSwapBuffers
 */
static BOOL broadway_wglSwapBuffers( HDC hdc )
{
...
static void init_extensions(void)
{
    ...
    egl_funcs.ext.p_wglCreateContextAttribsARB = broadway_wglCreateContextAttribsARB;

    register_extension("WGL_ARB_extensions_string");
    egl_funcs.ext.p_wglGetExtensionsStringARB = broadway_wglGetExtensionsStringARB;

    register_extension("WGL_ARB_make_current_read");
    egl_funcs.ext.p_wglGetCurrentReadDCARB   = (void *)1;  /* never called */
    egl_funcs.ext.p_wglMakeContextCurrentARB = broadway_wglMakeContextCurrentARB;

    register_extension("WGL_EXT_extensions_string");
    egl_funcs.ext.p_wglGetExtensionsStringEXT = broadway_wglGetExtensionsStringEXT;

    register_extension("WGL_EXT_swap_control");
    egl_funcs.ext.p_wglSwapIntervalEXT = broadway_wglSwapIntervalEXT;
    egl_funcs.ext.p_wglGetSwapIntervalEXT = broadway_wglGetSwapIntervalEXT;
    ...
    egl_funcs.ext.p_wglSetPixelFormatWINE = broadway_wglSetPixelFormatWINE;

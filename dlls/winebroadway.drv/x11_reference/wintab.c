 ...
 */
NTSTATUS broadwaydrv_tablet_load_info( void *hwnd )
{
 ...
 */
NTSTATUS broadwaydrv_tablet_attach_queue( void *owner )
{
    struct broadwaydrv_thread_data *data = broadwaydrv_init_thread_data();
    int             num_devices;
    int             loop;
 ...
 */
NTSTATUS broadwaydrv_tablet_get_packet( void *packet )
{
 ...
 */
NTSTATUS broadwaydrv_tablet_info( void *arg )
{
 ...
 *           broadwaydrv_tablet_get_packet
 */
NTSTATUS broadwaydrv_tablet_get_packet( void *arg )
{
    return 0;
}
 ...
 *           broadwaydrv_tablet_load_info
 */
NTSTATUS broadwaydrv_tablet_load_info( void *arg )
{
    return FALSE;
}

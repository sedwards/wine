...
static BOOL xrandr10_get_id( const WCHAR *device_name, BOOL is_primary, broadwaydrv_settings_id *id )
{
...
static BOOL xrandr10_get_modes( broadwaydrv_settings_id id, DWORD flags, DEVMODEW **new_modes, UINT *new_mode_count )
{
...
static BOOL xrandr10_get_current_mode( broadwaydrv_settings_id id, DEVMODEW *mode )
{
...
static LONG xrandr10_set_current_mode( broadwaydrv_settings_id id, const DEVMODEW *mode )
{
    XRRScreenConfiguration *screen_config;
    Rotation rotation;
    SizeID size_id;
...
static unsigned int get_edid( RROutput output, unsigned char **prop )
{
    ...
    result = pXRRGetOutputProperty( gdi_display, output, broadwaydrv_atom(EDID), 0, 128, FALSE, FALSE,
...
static BOOL xrandr14_get_id( const WCHAR *device_name, BOOL is_primary, broadwaydrv_settings_id *id )
{
...
static BOOL xrandr14_get_modes( broadwaydrv_settings_id id, DWORD flags, DEVMODEW **new_modes, UINT *mode_count )
{
...
static BOOL xrandr14_get_current_mode( broadwaydrv_settings_id id, DEVMODEW *mode )
{
...
static LONG xrandr14_set_current_mode( broadwaydrv_settings_id id, const DEVMODEW *mode )
{

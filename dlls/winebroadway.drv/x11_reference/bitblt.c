...
static struct broadwaydrv_window_surface *get_x11_surface( struct window_surface *surface )
{
    return (struct broadwaydrv_window_surface *)surface;
}
 ...
 */
static void update_surface_region( struct broadwaydrv_window_surface *surface )
{
#ifdef HAVE_LIBXSHAPE
    char buffer[4096];
 ...
 *           set_color_key
 */
static void set_color_key( struct broadwaydrv_window_surface *surface, COLORREF key )
{
...
/***********************************************************************
 *           broadwaydrv_surface_lock
 */
static void broadwaydrv_surface_lock( struct window_surface *window_surface )
{
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );

    pthread_mutex_lock( &surface->mutex );
}

/***********************************************************************
 *           broadwaydrv_surface_unlock
 */
static void broadwaydrv_surface_unlock( struct window_surface *window_surface )
{
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );
...
/***********************************************************************
 *           broadwaydrv_surface_get_bitmap_info
 */
static void *broadwaydrv_surface_get_bitmap_info( struct window_surface *window_surface, BITMAPINFO *info )
{
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );
...
/***********************************************************************
 *           broadwaydrv_surface_get_bounds
 */
static RECT *broadwaydrv_surface_get_bounds( struct window_surface *window_surface )
{
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );
...
/***********************************************************************
 *           broadwaydrv_surface_set_region
 */
static void broadwaydrv_surface_set_region( struct window_surface *window_surface, HRGN region )
{
    RGNDATA *data;
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );
...
/***********************************************************************
 *           broadwaydrv_surface_flush
 */
static void broadwaydrv_surface_flush( struct window_surface *window_surface )
{
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );
...
/***********************************************************************
 *           broadwaydrv_surface_destroy
 */
static void broadwaydrv_surface_destroy( struct window_surface *window_surface )
{
    struct broadwaydrv_window_surface *surface = get_x11_surface( window_surface );
...
static const struct window_surface_funcs broadwaydrv_surface_funcs =
{
    broadwaydrv_surface_lock,
    broadwaydrv_surface_unlock,
    broadwaydrv_surface_get_bitmap_info,
                                       ...
                                       COLORREF color_key, BOOL use_alpha )
{
    ...
    surface = calloc( 1, FIELD_OFFSET( struct broadwaydrv_window_surface, info.bmiColors[colors] ));
    ...
    surface->header.funcs = &broadwaydrv_surface_funcs;
...
failed:
    broadwaydrv_surface_destroy( &surface->header );
    return NULL;
}
...
void set_surface_color_key( struct window_surface *window_surface, COLORREF color_key )
{
    ...
    if (window_surface->funcs != &broadwaydrv_surface_funcs) return;  /* we may get the null surface */
...
HRGN expose_surface( struct window_surface *window_surface, const RECT *rect )
{
    ...
    if (window_surface->funcs != &broadwaydrv_surface_funcs) return 0;  /* we may get the null surface */

...
extern void BROADWAY_SetCursor( HWND hwnd, HCURSOR handle ) DECLSPEC_HIDDEN;
extern BOOL BROADWAY_CreateDesktop( const WCHAR *name, UINT width, UINT height ) DECLSPEC_HIDDEN;
extern BOOL BROADWAY_CreateWindow( HWND hwnd ) DECLSPEC_HIDDEN;
extern void BROADWAY_DestroyWindow( HWND hwnd ) DECLSPEC_HIDDEN;
extern BOOL BROADWAY_ProcessEvents( DWORD mask ) DECLSPEC_HIDDEN;
extern LRESULT BROADWAY_DesktopWindowProc( HWND hwnd, UINT msg, WPARAM wp, LPARAM lp ) DECLSPEC_HIDDEN;
extern void BROADWAY_SetLayeredWindowAttributes( HWND hwnd, COLORREF key, BYTE alpha,
                                                DWORD flags ) DECLSPEC_HIDDEN;
extern void BROADWAY_SetParent( HWND hwnd, HWND parent, HWND old_parent ) DECLSPEC_HIDDEN;
extern void BROADWAY_SetWindowRgn( HWND hwnd, HRGN hrgn, BOOL redraw ) DECLSPEC_HIDDEN;
extern void BROADWAY_SetCapture( HWND hwnd, UINT flags ) DECLSPEC_HIDDEN;
extern void BROADWAY_SetWindowStyle( HWND hwnd, INT offset, STYLESTRUCT *style ) DECLSPEC_HIDDEN;
extern UINT BROADWAY_ShowWindow( HWND hwnd, INT cmd, RECT *rect, UINT swp ) DECLSPEC_HIDDEN;
extern BOOL BROADWAY_UpdateLayeredWindow( HWND hwnd, const UPDATELAYEREDWINDOWINFO *info,
                                         const RECT *window_rect ) DECLSPEC_HIDDEN;
extern LRESULT BROADWAY_WindowMessage( HWND hwnd, UINT msg, WPARAM wp, LPARAM lp ) DECLSPEC_HIDDEN;
extern BOOL BROADWAY_WindowPosChanging( HWND hwnd, HWND insert_after, UINT swp_flags,
                                       const RECT *window_rect, const RECT *client_rect,
                                       RECT *visible_rect, struct window_surface **surface ) DECLSPEC_HIDDEN;
extern void BROADWAY_WindowPosChanged( HWND hwnd, HWND insert_after, UINT swp_flags,
                                      const RECT *window_rect, const RECT *client_rect,
...
extern NTSTATUS broadway_dispatch_ioctl( void *arg ) DECLSPEC_HIDDEN;
extern NTSTATUS broadway_java_init( void *arg ) DECLSPEC_HIDDEN;
extern NTSTATUS broadway_java_uninit( void *arg ) DECLSPEC_HIDDEN;
extern NTSTATUS broadway_register_window( void *arg ) DECLSPEC_HIDDEN;
...
enum broadway_window_messages
{
    WM_BROADWAY_REFRESH = 0x80001000,
};

...
static BOOL xf86vm_get_id(const WCHAR *device_name, BOOL is_primary, broadwaydrv_settings_id *id)
{
...
static BOOL xf86vm_get_modes(broadwaydrv_settings_id id, DWORD flags, DEVMODEW **new_modes, UINT *mode_count)
{
...
static BOOL xf86vm_get_current_mode(broadwaydrv_settings_id id, DEVMODEW *mode)
{
...
static LONG xf86vm_set_current_mode(broadwaydrv_settings_id id, const DEVMODEW *mode)
{
...
static BOOL xf86vm_get_gamma_ramp(struct broadwaydrv_gamma_ramp *ramp)
{
    WORD *red, *green, *blue;
    BOOL ret;
...
static BOOL xf86vm_set_gamma_ramp(struct broadwaydrv_gamma_ramp *ramp)
{
    WORD *red, *green, *blue;
    BOOL ret;

 ...
 */
NTSTATUS WINAPI broadwaydrv_dnd_position_event( void *arg, ULONG size )
{
...
NTSTATUS broadwaydrv_dnd_drop_event( UINT arg )
{
 ...
 */
NTSTATUS broadwaydrv_dnd_leave_event( UINT arg )
{
    IDropTarget *dropTarget;
 ...
 */
NTSTATUS WINAPI broadwaydrv_dnd_enter_event( void *params, ULONG size )
{
...
NTSTATUS WINAPI broadwaydrv_dnd_post_drop( void *data, ULONG size )
{
    HDROP handle;
